...
std::vector<int> ground_classes_except_terrain = {ROAD, PARKING, SIDEWALKR, OTHER_GROUND,
                                                  LANE_MARKING};
...
void discern_ground(const pcl::PointCloud<PointXYZILID>& src, pcl::PointCloud<PointXYZILID>& ground,
...
void discern_ground_without_vegetation(const pcl::PointCloud<PointXYZILID>& src,
...
void save_all_labels(const pcl::PointCloud<PointXYZILID>& pc, string ABS_DIR, string seq,
                     int count) {
...
void save_all_accuracy(const pcl::PointCloud<PointXYZILID>& pc_curr,
                       ...
                       double& accuracy, map<int, int>& pc_curr_gt_counts,
